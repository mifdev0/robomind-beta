...
const Hero = () => {
  ...
  const heroData = {
    ...
    subtitle: i18n.language === 'en'
      ? 'See real RoboMind learning moments while children build focus, logic, and confidence through guided play.'
      : 'Lihat momen nyata pembelajaran RoboMind saat anak membangun fokus, logika, dan kepercayaan diri melalui permainan terpandu.',
    video: '/assets/image hero/video-hero-optimized.mp4',
  };

  return (
    <section id="beranda" className="relative w-full h-[85vh] min-h-[580px] sm:h-[70vh] md:h-[60vh] lg:h-[620px] bg-black overflow-hidden">
